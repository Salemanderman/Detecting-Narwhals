...
def main():
    ...
    ap.add_argument("--audio-crop-end-secs",   type=int, default=cfg.get('audio_crop_end_secs',   5), help="Crop end of each recording to the nearest multiple of this many seconds (default: 5).")
    ...
    if not args.skip_extraction:
        ...
        cmd.extend(["--audio-crop-end-secs",   str(args.audio_crop_end_secs)])
