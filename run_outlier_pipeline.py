...
def main():
    ...
    ap.add_argument("--audio-root", default=cfg['audio_root'], help="Directory containing raw .wav audio files.")
    ap.add_argument("--npz-root", default=cfg['npz_root'], help="Directory for storing .npz files.")
    ap.add_argument("--output-root", default=cfg['output_root'], help="Base output directory for all pipeline results.")
    ...
    ap.add_argument("--feature-mode", choices=["mean_std", "mfcc"], default=cfg['feature_mode'], help=f"Feature type for UMAP (default: {cfg['feature_mode']}).")
