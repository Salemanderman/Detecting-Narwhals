...
def main():
    ...
    ap.add_argument("--mel-start", type=int,   default=11, help="First mel bin to include (default: 11).")
    ...
    ap.add_argument("--n-components", type=int, default=20, help="Number of PCA components to keep.")
